...
public abstract class ApiOverallReport {
    ...
    public void startwork(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, com.example.tracking_corona.network.Urls.overallReportUrl, new Response.Listener<String>() {
            @Override
